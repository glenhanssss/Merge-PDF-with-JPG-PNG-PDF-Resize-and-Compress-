...
def resize_and_compress_images(pdf_paths, image_paths, target_size=(620, 877), quality=85):
    converted_pdfs = []
...
def main():
    ...
    converted_pdfs = resize_and_compress_images(pdf_files, image_files)
    ...
    # Merge all PDFs
    merge_pdfs(output_pdf_path, *converted_pdfs)
